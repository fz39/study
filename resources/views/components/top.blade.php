    ...
    <div class="width100 float_l height80 line_hei80">
        ...
        <div class="float_l">
            <div class="float_l margin_l20">
                <img src="{{ URL::asset('img/uiz1.png') }}">
            </div>
            <div class="float_l">
        ...
        <div class="float_r">
            <div class="float_l top_input">
                ...
                <img class="img_sousuo bianshou" src="{{ URL::asset('img/uiz4.png') }}">
            </div>
            <div class="float_l margin_l20">
                <img src="{{ URL::asset('img/uiz5.png') }}">
            </div>
            <div class="float_l margin_l40">
                <img src="{{ URL::asset('img/uiz3.png') }}">
            </div>
            <div class="float_l margin_l35">
                <img src="{{ URL::asset('img/uiz6.png') }}">
            </div>
