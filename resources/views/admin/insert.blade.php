    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/admin/insert_to" method="post" enctype="multipart/form-data">
...
<!--                            </tr>-->
                            <tr>
                                ...
                                <td><input class="common-text" name="goods_img" size="50" value="" type="file"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>商品价格：</th>
                                <td><input class="common-text" name="goods_price" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>商品积分：</th>
                                <td><input class="common-text" name="goods_integral" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>内容：</th>
                                <td><textarea name="goods_count" class="common-textarea" id="content" cols="30" style="width: 42%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
